...
public class Runner extends Application
{
	...
	{ 
		...
		primaryStage.setTitle("Animal Care");
		/*
		...
		*/
		...
		{
			//title.stop();
			String feedURI = new File("C:\\Users\\BT_1N3_18\\git\\AnimalCare\\AnimalCare\\src\\sound\\eat3.mp3").toURI().toString();
			SoundEffect feedSound = new SoundEffect(feedURI, false);
			feedSound.play();
			//title.play();
		...
		clean.setOnAction(e->
		{
			/*
			title.stop();
			String cleanURI = new File("C:\\Users\\BT_1N3_18\\git\\AnimalCare\\AnimalCare\\src\\sound\\splash.mp3").toURI().toString();
			SoundEffect cleanSound = new SoundEffect(cleanURI, false);
			cleanSound.play();
			title.play();
			*/
		...
		medicate.setOnAction(e->
		{
			/*
			title.stop();
			String medicateURI = new File("C:\\Users\\BT_1N3_18\\git\\AnimalCare\\AnimalCare\\src\\sound\\splash.mp3").toURI().toString();
			SoundEffect medicateSound = new SoundEffect(medicateURI, false);
			medicateSound.play();
			title.play();
			*/
